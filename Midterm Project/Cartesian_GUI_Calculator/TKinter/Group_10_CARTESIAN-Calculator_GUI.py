...
FI = LabelFrame(gui,text="           Link Lengths and Joint Variables",font=(12),bg="gray85",fg="midnightblue")
...
model1 = ImageTk.PhotoImage(Image.open("cart.png").resize((390,290)))
